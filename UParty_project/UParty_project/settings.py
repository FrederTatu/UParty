"""
Django settings for UParty_project project.
...
SECRET_KEY = 'django-insecure-olr6jna&l@s^17q*^xdh3t_h=0!b^q!^7mt%te)waoh0m^+fv!'
...
WSGI_APPLICATION = 'UParty_project.wsgi.application'
...
EMAIL_PORT = 465
EMAIL_USE_SSL = True
EMAIL_HOST_USER = 'noreply@uparty.online'
EMAIL_HOST_PASSWORD = 'XRGK0faeyYLGbHDfh8Tn'
DEFAULT_FROM_EMAIL = 'noreply@uparty.online'